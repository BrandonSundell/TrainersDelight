        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BFP = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClientId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BMI = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    DateOfMessurment = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClientId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WeightInPounds = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    DateOfMessurment = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
